namespace WebAssignmentt.Models
{
    ...
    public static class PopularMoviesRepo
    {
        ...
        static PopularMoviesRepo()
        {
            ...
            {
                new PopularMovies(){name="Doctor Strange",duration=126,imgurl="https://m.media-amazon.com/images/M/MV5BNWM0ZGJlMzMtZmYwMi00NzI3LTgzMzMtNjMzNjliNDRmZmFlXkEyXkFqcGdeQXVyMTM1MTE1NDMx._V1_FMjpg_UX1000_.jpg",category="Action",viewurl="doctor-strange"},
