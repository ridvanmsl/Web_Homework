namespace WebAssignmentt.Models
{
    ...
    public static class PopularMoviesRepo
    {
        ...
        static PopularMoviesRepo()
        {
            ...
            {
                new PopularMovies(){name="Doctor Strange",duration=126,imgurl="https://m.media-amazon.com/images/M/MV5BNWM0ZGJlMzMtZmYwMi00NzI3LTgzMzMtNjMzNjliNDRmZmFlXkEyXkFqcGdeQXVyMTM1MTE1NDMx._V1_FMjpg_UX1000_.jpg",category="Action"},
                ...
                new PopularMovies(){name="Interstellar",duration=169,imgurl="https://imageio.forbes.com/specials-images/imageserve/61116cea2313e8bae55a536a/-Dune-/0x0.jpg?format=jpg&width=960",category="Science Fiction"},
